...
\begin{figure*}[t]
  ...
  \caption{SAE dissection of frozen-encoder emotion features (HuBERT / CREMA-D). \textbf{Top, left to right:} depth decode-vs-disentangle (probe accuracy vs.\ \# monosemantic emotion features); emotion features acoustic vs lexical (eGeMAPS vs.\ sentence firing-AUC); cross-encoder feature overlap. \textbf{Bottom:} emotion features per encoder; cross-speaker (leave-speaker-out) generalization; causal sufficiency of acoustic vs.\ lexical vs.\ random features.}
  \label{fig:summary}
\end{figure*}
